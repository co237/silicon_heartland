...
# load crosswalks
cip_2020_crosswalk <- read_excel("CIP_HT_2020.xlsx")
cip_2010_crosswalk <- read_excel("CIP_HT_2010.xlsx")

# Bachelor's degrees by school by year, 2014-2023 - 6 digit CIP codes
ipeds_2023<- read.csv(file.path("IPEDS Degrees", "CSV_432025-1011.csv"))
ipeds_2022<- read.csv(file.path("IPEDS Degrees", "CSV_432025-237.csv"))
ipeds_2021<- read.csv(file.path("IPEDS Degrees", "CSV_432025-850.csv"))
ipeds_2020<- read.csv(file.path("IPEDS Degrees", "CSV_432025-639.csv"))
ipeds_2019<- read.csv(file.path("IPEDS Degrees", "CSV_432025-347.csv"))
ipeds_2018<- read.csv(file.path("IPEDS Degrees", "CSV_432025-641.csv"))
ipeds_2017<- read.csv(file.path("IPEDS Degrees", "CSV_432025-525.csv"))
ipeds_2016<- read.csv(file.path("IPEDS Degrees", "CSV_432025-428.csv"))
ipeds_2015<- read.csv(file.path("IPEDS Degrees", "CSV_432025-154.csv"))
ipeds_2014<- read.csv(file.path("IPEDS Degrees", "CSV_432025-587.csv"))
...
ipeds_2023 <- left_join(ipeds_2023,cip_2020_crosswalk, by = c("CIP_2020" = "CIP_2020") )
...
ipeds_2022 <- left_join(ipeds_2022,cip_2020_crosswalk, by = c("CIP_2020" = "CIP_2020") )
...
ipeds_2021 <- left_join(ipeds_2021,cip_2020_crosswalk, by = c("CIP_2020" = "CIP_2020") )
...
ipeds_2020 <- left_join(ipeds_2020,cip_2020_crosswalk, by = c("CIP_2020" = "CIP_2020") )
...
ipeds_2019 <- left_join(ipeds_2019,cip_2010_crosswalk, by = c("CIP_2010" = "CIP_2010") )
...
ipeds_2018 <- left_join(ipeds_2018,cip_2010_crosswalk, by = c("CIP_2010" = "CIP_2010") )
...
ipeds_2017 <- left_join(ipeds_2017,cip_2010_crosswalk, by = c("CIP_2010" = "CIP_2010") )
...
ipeds_2016 <- left_join(ipeds_2016,cip_2010_crosswalk, by = c("CIP_2010" = "CIP_2010") )
...
ipeds_2015 <- left_join(ipeds_2015,cip_2010_crosswalk, by = c("CIP_2010" = "CIP_2010") )
...
ipeds_2014 <- left_join(ipeds_2014,cip_2010_crosswalk, by = c("CIP_2010" = "CIP_2010") )
